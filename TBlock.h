...
void TBlock::draw(int board[22][12])
{
...
void TBlock::moveLeft(int board[22][12])
{
    if(!DROP)
    {
        return;
...
void TBlock::moveRight(int board[22][12])
{
    if(!DROP)
    {
        return;
...
void TBlock::dropSet(int board[22][12])
{
    int n = 1;
...
bool TBlock::moveDown(int board[22][12])
{
    if(!DROP)
    {
        return false;
...
//Rotates the block
void TBlock::rotate(int board[22][12])
{
    if(!DROP)
    {
        return;
    ...
    if(POSITION1 && !POSITION2 && !POSITION3 && !POSITION4)
    { //If block is in original T position
    ...
    { /*The block is in the 2nd position:
                                                                   /1/
                                                                   /3/ /2/
                                                                   /4/   */
    ...
    {  /*The block is in the 4th position:
                                                                    /4/
                                                                    /2/ /3/
                                                                    /1/     */
