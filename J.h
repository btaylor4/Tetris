...
void J::dropSet(int board[22][12])
{
    ...
    if(POSITION3)
    {
        ...
        while(board[Y1 + n][X1] == 0 && board[Y3 + n][X3] == 0 && board[Y1 + n][X1] == 0) //while(board[Y4 + n][X4] == 0 && board[Y3 + n][X3] == 0 && board[Y1 + n][X1] == 0)
        {
            n++;
        }
...
void J::rotate(int board[22][12])
{
    ...
    if(POSITION1)
    {
        ...
        //Check proJected rotation path for 2nd block
    ...
    else if(POSITION2)
    {
        ...
        else if(board[Y2+1][X2+1] != 0) //else if(board[Y2-1][X2+1] != 0)
        {
            return;
        }
        
        //Check proJected rotation for 4th block
        else if(board[Y4][X4-1] != 0 || board[Y4-1][X4-1] != 0) //else if(board[Y4][X4-1] != 0 || board[Y1-1][X1-1] != 0)
        {
            return;
        }
    ...
    {
        //Check proJected rotation for 1st block
        if(board[Y1-2][X1] != 0) //if(board[Y1][X1-2] != 0)
        {
            return;
        }
